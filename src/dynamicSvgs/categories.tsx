...
export const categoriesSvg: Record<string, JSX.Element> ={
    phone:
    <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_811_868)">
