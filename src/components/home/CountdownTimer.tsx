  ...
  return (
    <div className="flex items-center gap-2 lg:gap-[15px] ">
      ...
      <div className="text-center  ">
        <div className="font-poppins font-medium text-[12px] leading-[18px] text-black mb-[15px]">
          Days
        </div>
        <div className="font-inter font-bold text-[32px] leading-[30px] tracking-[0.04em] text-black">
          {timeLeft.days}
        </div>
      </div>

      <span className="text-[#E07575] font-bold text-2xl">:</span>
